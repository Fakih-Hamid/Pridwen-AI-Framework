...
## 📖 Project Abstract
**Pridwen** is an offline-first, gamified cybersecurity education framework designed to address the "Human Factor" in digital security. It is specifically engineered to empower **beginners and non-technical users across diverse demographics**, ensuring accessible training regardless of IT background.
